			...
			<h4>Add a new Character</h4>
				<form action="insert-character.php" method="get" class="form-horizontal">
					<div class="form-group">
						...
						<label for="name" class="col-sm-2 control-label">Person id</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="personID" name="personID" placeholder="Person ID">
							</div>
					</div>
					<div class="form-group">
				...
				<form action="insert-company.php" method="get" class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select id="countryCode" name="countries">
				...
				<form action="insert-person.php" method="get" class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-10">
							Birth Date
							<input type="date" class="form-control" id="personBirthDate" name="personBirthDate">
						</div>
						
						<label for="personBirthName" class="col-sm-2 control-label">Birth name</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="personBirthName" name="personBirthName" placeholder="Birth name">
						</div>

						<label for="personTrivia" class="col-sm-2 control-label">Trivia</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="personTrivia" name="personTrivia" placeholder="Trivias">
						</div>
						
						<label for="personQuotes" class="col-sm-2 control-label">Quotes</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="personQuotes" name="personQuotes" placeholder="Famous quotes">
						</div>
						
						<label for="personSpouse" class="col-sm-2 control-label">Spouse</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="personSpouse" name="personSpouse" placeholder="Spouse name">
						</div>

						<label for="personBio" class="col-sm-2 control-label">Biography</label>
						<div class="col-sm-10">
							<textarea name="personBio" cols="40" rows="5" ... placeholder=" Biography..."></textarea> 
						</div>
